...
let RefreshGuard = exports.RefreshGuard = class RefreshGuard {
    constructor(redisRepository, logger, authService) {
    ...
    async canActivate(ctx) {
        ...
        try {
            const payload = (await this.authService.tokenVerify(refreshToken));
...
exports.RefreshGuard = RefreshGuard = __decorate([
    __param(0, (0, common_1.Inject)(redis_1.RedisRepository)),
    __param(1, (0, common_1.Inject)(logger_service_1.CustomLoggerService)),
